...
<header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li><a href="profile.jsp"  >Food Available List</a></li>
                <li><a href="request1.jsp" class="active">Request List</a></li>
            </ul>
        </nav>
    </header>
    <script>
        ...
        hamburger.onclick =function(){
         ...
         <hr>
         <br>
         <p class="heading">Request List</p>
   ...
   <div class="table-container">
        ...
        <c:forEach var="user" items="${userListt}">
    <tr>
        <td>${user.name}</td>
        <td>${user.quantity}</td>
        <td>${user.email}</td>
